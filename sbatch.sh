...
python ~/projects/def-atrabels-ab/ubaida/Steretoype-in-language/train_roberta3_final.py --mode train --pre_trained_model_name_or_path roberta-base --train_path "~/home/ubaida/projects/def-atrabels-ab/ubaida/Steretoype-in-language/data/train.csv" --val_path "~/home/ubaida/projects/def-atrabels-ab/ubaida/Steretoype-in-language/data/val.csv" --test_path "~/home/ubaida/projects/def-atrabels-ab/ubaida/Steretoype-in-language/data/test.csv" --lr 0.0001 --max_len 50 --max_epochs 30 --batch_size 128 --model_saving_path "roberta3"
